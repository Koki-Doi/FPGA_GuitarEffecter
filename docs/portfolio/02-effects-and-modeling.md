...
今も rejected のままですが、現行 D148 の Amp source は D99/D121 untouched ではありません。
...
| D122 / D128 / D130 / D135 | 既存 ampScoop / presence / drive bonus / darken / treble trim / MIDDLE / power-headroom の measured retune | accepted Amp line（D148 にも含まれる） |
| D147 / D148 | amp sag-attack slew（chord-IMD 修正）+ JC-120 / Fender-Twin clean-headroom fix（`ampPowerKnee` / `ampCleanKneeBonus`） | 現行 D148 Amp の accepted line |
