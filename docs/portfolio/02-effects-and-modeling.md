...
今も rejected のままですが、現行 D131 の Amp source は D99/D121 untouched ではありません。
...
| D122 / D128 / D130 | 既存 ampScoop / presence / drive bonus / darken / treble trim の measured retune | 現行 D131 Amp の accepted line |
...
- Big Muff は単純な 1 段クリップではなく **`bigMuffOsCascade`**（D131 現行は
