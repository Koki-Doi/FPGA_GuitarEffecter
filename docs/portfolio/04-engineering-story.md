...
| 採用ベースライン（D135）の WNS | +0.643 ns（WHS +0.018 ns、route errors 0） |
...
**現行 D135 bit/hwh**：`533d586901dc3669285a49c6d82bab9f` /
`731517487c6218f0e181c2b74485d7a6`。小さなプロトタイプではなく、HDMI / input IP /
...
| D135 | **現行 canonical baseline**。Fuzz Face mid-hump + Amp/Cab character、bench-ACCEPTED |
...
です。D121 当時は D99 系 Amp character を保持していたため、この節は「現行 D135 Amp がこうなっている」
