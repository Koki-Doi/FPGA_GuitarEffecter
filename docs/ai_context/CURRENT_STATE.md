...
See `docs/ai_context/HDMI_GUI_PHASE6H_PORT_1PY_SPEC.md`.
...
**not committed**. See
`docs/ai_context/HDMI_GUI_PHASE6H_NATIVE_800X480_TIMING.md` and
`docs/ai_context/HDMI_GUI_PHASE6I_800X480_TIMING_SWEEP.md`.
