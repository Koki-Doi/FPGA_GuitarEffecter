...
| [`DIGITAL_SOUND_REDUCTION.md`](DIGITAL_SOUND_REDUCTION.md) | Why the effects still sound "digital" and how to fix it, ranked: the 4-tap cabinet (real cab IR step B) and the still-un-oversampled Amp/Overdrive/DS-1 clips are the dominant aliasing tells; gated by an island 40 -> 33 MHz headroom phase. Plus dynamics, tone biquads, and the Hi-Z front-end. |
