...
Status: **work order CONVERGED at the 2026-06-17 realism baseline `54f7f547`**
(updated 2026-06-17). D121 以降で AudioLab を実機らしい方向へ寄せるための作業順と
...
残る主対象は新 stage を伴う大きい realism work のみ: real-IR cab convolution、
Fuzz Face mid-hump、JCM800/Vox presence shelf。
...
- 現在の canonical deployed voicing baseline は **D131**（merge `37114b9`、bit
  `fdab62d5ef229ec64dc60fe9395cbf06`、hwh
  `d852ec4e737460ad016b41f0a3f71de2`）。この work order は D121 時点から
...
- D122-D131 で Amp/Cab/RAT/Compressor/OD/DS/DIST の追加測定修正が
  bench-ACCEPTED され、D131 が現在の canonical baseline。
