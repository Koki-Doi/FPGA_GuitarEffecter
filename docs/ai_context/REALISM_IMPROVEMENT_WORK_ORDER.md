...
Status: **work order CONVERGED at D135 (`533d5869`); current baseline D148 (`96ef899`)**
(updated 2026-06-20). D121 以降で AudioLab を実機らしい方向へ寄せるための作業順と
...
され、現行 baseline は **D148**（`96ef899`）。残る主対象は real-IR cab convolution。
...
- 現在の canonical deployed voicing baseline は **D148**（merge `96ef899`、bit
  `972d9ba6645dd966e6bdcb5bc3daf478`、hwh
  `2b888ff1ec3168cd64e1b679bbbc71be`）= JC/Twin clean-headroom fix + D146 hard
