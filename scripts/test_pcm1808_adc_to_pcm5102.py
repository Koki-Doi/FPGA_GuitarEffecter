...
JB_WIRING = (
    "  JB1 (W14)  EXT_AUDIO_MCLK  -> PCM1808 SCKI  = 12.288 MHz (clk_wiz_audio_ext)\n"
    "  JB2 (Y14)  EXT_AUDIO_BCLK  -> PCM1808 BCK + PCM5102 BCK = ADAU BCLK (~3.072 MHz)\n"
    "  JB3 (T11)  EXT_AUDIO_LRCLK -> PCM1808 LRCK + PCM5102 LCK = ADAU LRCLK (~48 kHz)\n"
    "  JB4 (T10)  EXT_ADC_DOUT    <- PCM1808 DOUT  (NEW input, Phase 7D)\n"
    "  JB7 (V16)  EXT_DAC_DIN     -> PCM5102 DIN   = i2s_to_stream_0/so (unchanged)\n"
    "  PCM5102 SCK -> hard-wired to GND on the module (NOT JB1).\n"
