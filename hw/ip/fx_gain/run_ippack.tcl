...
set IPName      "fx_gain"
set Version     "1.0"
set DisplayName "Fx_gain"
set Revision [clock seconds]
...
set sdx_kernel_name "fx_gain"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "/home/doi20/Audio-Lab-PYNQ/hw/fx_gain/sol1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {fx_gain_mul_mul_16s_24s_40_1_1
fx_gain_CTRL_s_axi
clip24
fx_gain
}
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axis m_axis"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
