...
**D76 (FP02M expression pedal -> Wah POSITION, XADC re-add on the D75 DSP
clock-domain island)** で、`.bit = 9fdecae0c7d7cf3c59422cec2b30368f`、
`.hwh = a9fd74082482aa1b074fc3c31ccd6283` です。rollback baseline は
D75 (`.bit = 4a0b3dae1e56574ad596dbd6a3f0c98f` /
`.hwh = 347d3e553a8ca96733ee27e904a1d25f`)、その下が D73。
...
5 行とも同じ md5 が出れば OK。最新の accepted deployed build (D76) の md5 は
`9fdecae0c7d7cf3c59422cec2b30368f` (`.bit`) /
`a9fd74082482aa1b074fc3c31ccd6283` (`.hwh`) です。
